...
function searchSkills(){
  ...
  if [ "$checkSkills" ]; then
    sleep 1
    echo -e "\n${yellowColour}[+]${endColour} Llistant les maquines amb la skill indicada ${yellowColour}$skills${endColour}:\n"
    sleep 1 
...
function getLOInfo(){
  ...
  if [ "$check_LO_results" ]; then
    ...
    sleep 1 
    echo -e "\n${redColour}[!]${endColour} Les maquines amb aquestes especificacions no existeixen o  el sistema operatiu ${blueColour}$osRunning${endColour} o dificultat ${purpleColour}$difLevel${endColour} especificats no son correctes"
  fi
  tput cnorm
}
...
function getCSInfo(){
  ...
  if [ "$check_CS_results" ]; then
    ...
    sleep 1 
    echo -e "\n${redColour}[!]${endColour} Les maquines amb aquestes especificacions no existeixen o  el certificat ${greenColour}$certs${endColour} o skill ${yellowColour}$skills${endColour} especificats no son correctes"
  fi
  tput cnorm
}
...
function getLOSInfo(){
  ...
  if [ "$check_LOS_results" ]; then
    ...
    sleep 1 
    echo -e "\n${redColour}[!]${endColour} Les maquines amb aquestes especificacions no existeixen o  el sistema operatiu ${blueColour}$osRunning${endColour}, dificultat ${purpleColour}$difLevel${endColour} o skill ${yellowColour}$skills${endColour} especificats no son correctes"
  fi
  tput cnorm
}
...
function getCSOInfo(){
  ...
  if [ "$check_CSO_results" ]; then
    ...
    sleep 1 
    echo -e "\n${redColour}[!]${endColour} Les maquines amb aquestes especificacions no existeixen o el certificat ${greenColour}$certs${endColour}, skill ${yellowColourColour}$skills${endColour} o sistema operatiu ${blueColour}$skills${endColour} especificats no son correctes"
  fi
  tput cnorm
}
...
function getLOCInfo(){
  ...
  if [ "$check_LOC_results" ]; then
    ...
    sleep 1 
    echo -e "\n${redColour}[!]${endColour} Les maquines amb aquestes especificacions no existeixen o  el sistema operatiu ${blueColour}$osRunning${endColour}, dificultat ${purpleColour}$difLevel${endColour} o certificat ${yellowColour}$certs${endColour} especificats no son correctes"
  fi
  tput cnorm
}
...
function getCSLInfo(){
  ...
  if [ "$check_CSL_results" ]; then
    ...
    sleep 1 
    echo -e "\n${redColour}[!]${endColour} Les maquines amb aquestes especificacions no existeixen o el certificat ${greenColour}$certs${endColour}, skill ${yellowColourColour}$skills${endColour} o dificultat ${purpleColour}$skills${endColour} especificats no son correctes"
  fi
  tput cnorm
}
...
function getLOSCInfo(){
  ...
  if [ "$check_LOSC_results" ]; then
    ...
    sleep 1 
    echo -e "\n${redColour}[!]${endColour} Les maquines amb aquestes especificacions no existeixen o el sistema operatiu ${blueColour}$osRunning${endColour}, dificultat ${purpleColour}$difLevel${endColour}, skill ${yellowColour}$skills${endColour} o certificat ${greenColour}$certs${endColour} especificats no son correctes"
  fi
  tput cnorm
}
